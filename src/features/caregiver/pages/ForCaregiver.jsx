                        ...
                        <div className="flex-1 flex flex-col gap-7 max-w-lg">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 pt-1">
                                <Link
                                    ...
                                    id="cta-hero-start"
                                    className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#102030] text-white rounded-xl font-semibold text-sm hover:bg-[#1a3248] transition-all hover:-translate-y-0.5 shadow-md hover:shadow-lg group"
                                >
                                    Đăng ký đi làm
